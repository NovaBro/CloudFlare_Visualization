...
export const Question1Map: React.FC = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      d3.json(`${import.meta.env.BASE_URL}files/89f81b1e8af0be836adcbbb1d37f7118947f0d21fdaaee4760b867433d09f169d6c4f1579de34e9311e6235b2433f02a327fc84f8e909ff30cbeb0dade4eb919.json`)
